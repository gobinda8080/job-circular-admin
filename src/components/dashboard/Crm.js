      ...
      <Row>
        ...
        <Col xl="4" className="xl-40 box-col-12">
          <Card className="crm-chart-card">
            <CardHeader className="pb-0"><span className="mt-0">September Total</span>
            ...
            <CardBody>
              ...
              <div className="full-chart-bottom">
                ...
                <Button className="btn gradient-danger btn-pill btn-block"><span className="pull-left">View Full Chart</span><span className="d-inline-block pull-right"><span className="round-icon"><ArrowRight /></span></span></Button>
              </div>
            </CardBody>
          </Card>
        </Col>
        ...
        <Col xl="4" lg="6" className="xl-50 box-col-12">
          <Card className="crm-total-user-card done-project-card">
            <CardBody>
              ...
              <h4 className="mb-0">Done Project</h4>
            </CardBody>
            <div className="apex-chart-container">
        ...
        <Col lg="6">
          <Card>
            <CardHeader className="card-header">
              <h5>Project Income</h5>
              <div className="card-header-right">
              </div>
            </CardHeader>
            <CardBody className="crm-dashboard-chart">
              <div className="crm-top-chart">
                <h1 className="font-info mb-0 counter">32</h1><span>Total Income</span><span className="d-block f-12"><span className="d-inline-block up-icon-middle"><i className="fa fa-sort-up mr-1 font-info"> </i></span>100%</span>
              </div>
        ...
        <Col lg="6">
          <Card>
            ...
            <CardBody className="crm-dashboard-chart">
              <div className="crm-top-chart">
                <h1 className="font-secondary mb-0 counter">26</h1><span>Total New Project</span><span className="d-block f-12"><span className="d-inline-block up-icon-middle"><i className="fa fa-sort-up mr-1 font-secondary"> </i></span>100%</span>
              </div>
        ...
        <Col xl="4" className="xl-50 box-col-6">
          <Card className="crm-user-profile-card">
            ...
            <CardBody>
              <ul>
                <li>
                  <h6><User/>Your Account</h6>
                </li>
                <li>
                  <h6> <CreditCard/>Invoices & Payments<span className="pull-right badge badge-pill pill-badge-secondary">2</span></h6>
                </li>
                <li>
                  <h6><Settings/>Setting</h6>
                </li>
                <li>
                  <h6> <FileText/>Your Services</h6>
                </li>
                <li>
                  <h6><LogOut/>Log Out</h6>
                </li>
              </ul>
            </CardBody>
          </Card>

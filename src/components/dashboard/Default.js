...
const Default = () => {
    ...
    console.log(isUser)
    const handleLogout = () =>{
      let isUser = localStorage.setItem('isUser', false)
...
//                           <Button color="light" outline className="btn-js1">From Date</Button>
//                           <Button color="light" outline className="btn-js1">To Date</Button>
...
//                             <div>
//                               <h6 className="f-w-600">March. 2019</h6><span className="f-w-600">Total Invest</span>
//                             </div>
//                           </div> */}
//                         </div>
//                       </Col>

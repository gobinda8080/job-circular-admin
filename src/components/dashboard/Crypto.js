          ...
          <Col xl="7" className="xl-100 box-col-12">
            <Card className="o-hidden">
              <CardBody className="crypto-current">
                <Row>
                  <Col xl="4" sm="6">
                    <div className="current-balance"><span className="f-12 f-w-600">Your Current Balance</span>
                  ...
                  <Col xl="3" sm="6">
                    <div className="crypto-amount">
                      <div className="amount-detail">
                        <label className="f-w-600 f-12">Card Number *</label>
                  ...
                  <Col xl="5">
                    <div className="crypto-amount">
                      <div className="amount-detail">
                        <label className="f-w-600 f-12">Expire Date</label>
          ...
          <Col xl="5" className="xl-100 box-col-12">
                <Card>
                  <CardBody className="distributed-crypto">
                    <Row>
                      <Col sm="6"><span className="f-12">Our Distributed</span>
                      ...
                      <Col sm="6" className="text-right"><span className="f-12">Our Contributed</span>
                  ...
                  <div className="media">
                    <div className="media-body d-flex">
                      ...
                      <div className="bitcoin-graph-content">
                        <h5>Bitcoin BTC</h5><span className="d-block f-12 f-w-600">0.00000112 BTC $0.05</span>
                      </div>
              ...
              <CardHeader>
                <div className="media">
                  <div className="media-body d-flex">
                    ...
                    <div className="bitcoin-graph-content">
                      <h5>Litecoin LTC</h5><span className="d-block f-12 f-w-600">0.00000348 LTC $0.02</span>
                    </div>
                  </div>
                ...
                <CardHeader>
                  <div className="media">
                    <div className="media-body d-flex">
                      ...
                      <div className="bitcoin-graph-content">
                        <h5>Ethereum ETH</h5><span className="d-block f-12 f-w-600">0.00000686 LTC $0.07</span>
                      </div>
          ...
          <Col xl="7" className="xl-100 box-col-12">
                <Card>
                  <CardHeader className="crypto-header">
                    <h5>Bitcoin Exchange ETH/BTC</h5>
                  ...
                  <CardBody>
                    <div className="apex-chart-container">
                      ...
                      <div className="our-growth-bottom crypto-graph-card">
                        <div className="media"><span className="f-12 f-w-600">Our Growth</span>

                      ...
                      <Col sm="6">
                        <div className="card overview-color">
                          <div className="card-body bg-gradient-danger text-center">
                            <h4>30+</h4>
                            <div className="btn btn-pill btn-sm f-12">Total Deals</div><img className="img-fluid img-80" src={handshake} alt=""/>
                          </div>
                        </div>
                      </Col>
                      <Col sm="6">
                        <div className="card overview-color">
                          <div className="card-body bg-gradient-primary text-center">
                            <h4>$1800</h4>
                            <div className="btn btn-pill btn-sm f-12">Today Earning</div><img className="img-fluid img-60" src={graph} alt=""/>
                          </div>
                        </div>
                      </Col>
                      <Col sm="12">
              ...
              <Col sm="12">
                <Card>
                  <CardHeader className="card-header crypto-header">
                    <h5>Monthly Revenue Progress</h5>
                    <div className="chart-value-box pull-right">
                      <div className="value-square-box-success mr-2"></div><span className="f-12 f-w-600">Highest Value</span>
                    </div>
                  </CardHeader>
                  <CardBody className="chart-block">
                    <div className="apex-chart-container">
                      ...
                      <div className="our-growth-bottom sass-graph-card">
                        <div className="media"><span className="f-12 f-w-600">Our Growth</span><span className="pull-right badge badge-pill ml-3"><span className="font-success"><span className="d-inline-block"><i className="fa fa-sort-up"></i></span> 9.4%</span></span></div>
                      </div>
                    </div>
                  </CardBody>
                </Card>

                    ...
                    <Col xl="9 xl-60">
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/1.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">UI/UX IT Frontend Developer</a><span className="badge badge-primary pull-right">New</span></h6>
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/2.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">React/React Native Developer</a><span className="badge badge-primary pull-right">New</span></h6>
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/3.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">Senior UX designer</a><span className="pull-right">2 days ago</span></h6>
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/4.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">Front end web developer</a><span className="pull-right">3 days ago</span></h6>
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/5.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">Graphic designer</a><span className="pull-right">3 days ago</span></h6>
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/6.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">Designer, CRM</a><span className="pull-right">3 days ago</span></h6>
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/2.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">UI designer E-commerce</a><span className="pull-right">5 days ago</span></h6>

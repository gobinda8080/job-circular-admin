            ...
            <Col xl="12 xl-50 box-col-6">
                <Card>
                    ...
                    <Collapse isOpen={isIntro}>
                        <CardBody className="filter-cards-view"><span className="f-w-600">About Me :</span>
                            <p>
                    ...
                    <Collapse isOpen={isFollowers}>
                        <CardBody className="social-list filter-cards-view">
                            <Media>
                                ...
                                <Media body><span className="d-block">Bucky Barnes</span><a href="#javascript">Add Friend</a></Media>
                            </Media>
                            <Media>
                                <img className="img-50 img-fluid m-r-20 rounded-circle" alt="threeImg" src={three} />
                                <Media body><span className="d-block">Sarah Loren</span><a href="#javascript">Add Friend</a></Media>
                            </Media>
                            <Media>
                                <img className="img-50 img-fluid m-r-20 rounded-circle" alt="threeImg" src={three} />
                                <Media body><span className="d-block">Jason Borne</span><a href="#javascript">Add Friend</a></Media>
                            </Media>
                            <Media>
                                <img className="img-50 img-fluid m-r-20 rounded-circle" alt="tenImg" src={ten} />
                                <Media body><span className="d-block">Comeren Diaz</span><a href="#javascript">Add Friend</a></Media>
                            </Media>
                            <Media>
                                <img className="img-50 img-fluid m-r-20 rounded-circle" alt="elevenImg" src={eleven} />
                                <Media body><span className="d-block">Andew Jon</span><a href="#javascript">Add Friend</a></Media>
                            </Media>
                        </CardBody>
                    </Collapse>
                </Card>

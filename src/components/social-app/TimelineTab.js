                                    ...
                                    <div className="social-chat">
                                        ...
                                        <div className="other-msg">
                                            <Media>
                                                ...
                                                <Media body><span className="f-w-600">Alexendra Dhadio <span>1 Month Ago <i className="fa fa-reply font-primary"></i></span></span>
                                        ...
                                        <div className="other-msg">
                                            <Media>
                                                ...
                                                <Media body><span className="f-w-600">Olivia Jon <span>15 Days Ago <i className="fa fa-reply font-primary"></i></span></span>
                                                    <p>ohh yeah very good car and its features i will surely vote for it </p>
                                                </Media>
                                            </Media>
                                        </div>
                                        <div className="your-msg">
                                            <Media>
                                                <Media className="img-50 img-fluid m-r-20 rounded-circle" alt="" src={one} />
                                                <Media body><span className="f-w-600">Issa Bell <span>1 Year Ago <i className="fa fa-reply font-primary"></i></span></span>
                                                    <p>we are doing dance and singing songs, please vote our post which is very good for all young peoples</p>
                                                </Media>
                                            </Media>
                                        </div>

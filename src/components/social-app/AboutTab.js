                                ...
                                <CardBody className="avatar-showcase">
                                    <div className="pepole-knows">
                                        <ul>
                                            ...
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="threeImg" src={three} /><span className="d-block f-w-600">Dion Cast</span>
                                                    <Button color="primary" size="xs">Add Friend</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="four" src={four} /><span className="d-block f-w-600">Karlene Lex</span>
                                                    <Button color="primary" size="xs">Add Friend</Button>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="tenImg" src={ten} /><span className="d-block f-w-600">Wai Schalk</span>
                                                    <Button color="primary" size="xs">Add Friend</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="" src={fourteen} /><span className="d-block f-w-600">Karlene Lex</span>
                                                    <Button color="primary" size="xs">Add Friend</Button>
                                                </div>
                                            </li>
                                        </ul>

                          ...
                          <div className="product-box row">
                              ...
                              <Col lg="6" className="product-details  text-left">
                                ...
                                <div className="product-qnty">
                                  ...
                                  <Link to={`${process.env.PUBLIC_URL}/ecommerce/cart`}><Button color="primary" className="mr-2 mt-2" onClick={() => addcart(singleProduct, quantity)}>Add to Cart</Button></Link>
                                  <Link to={`${process.env.PUBLIC_URL}/ecommerce/product-detail/1`}><Button color="primary" className="mr-2 mt-2">View Details</Button></Link>
                                  </div>
                                </div>
                              </Col>
                          </div>

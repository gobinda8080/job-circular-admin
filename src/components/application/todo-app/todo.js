...
import {GET_LIST,ADD_NEW_ITEM,REMOVE_ITEM,MARK_ALL_ITEMS,SELECTED_ITEM} from '../../../redux/actionTypes'
                      ...
                      <div className="todo-list-footer">
                        <div className="add-task-btn-wrapper"><span className="add-task-btn">
                            <Button color="primary"  onClick={openTaskWrapper}>
                              <i className="icon-plus"></i> Add new task</Button></span>
                        </div>
                        ...
                        <Button color="success" className="ml-3 add-new-task-btn" id="add-task" onClick={addNewTask}>Add Task</Button>
                        </div>
                      </div>
                    </div>
                  </div>

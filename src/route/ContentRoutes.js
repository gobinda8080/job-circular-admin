...
// Jobs
import GeneralWidget from '../app/AddJob'
import ChartWidget from '../app/JobList'
...
import Popover from '../app/AddOther'

import Tooltip from '../app/otherList'
...
export const routes = [
  ...
  { path: "/jobs/add",Component: GeneralWidget},
  { path: "/jobs/list",Component: ChartWidget},
  ...
  { path: "/others/add",Component: Popover},
  { path: "/others/list",Component: Tooltip},
  ...
  { path: "/editor/acecodeEditor" ,Component: AceCodeEditor},
